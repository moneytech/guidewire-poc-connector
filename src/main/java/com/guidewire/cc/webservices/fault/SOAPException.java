...
public class SOAPException  extends org.apache.axis.AxisFault  implements java.io.Serializable {
    ...
    /* Other messages attached to this exception. This message may
     * contain information
     ...
     * 
     * @return otherMessages   * Other messages attached to this exception. This message may
     * contain information
     * related to other exceptions that occurred during a SOAP call, but
     * not directly
     * associated with this particular exception.
     ...
     * 
     * @param otherMessages   * Other messages attached to this exception. This message may
     * contain information
     * related to other exceptions that occurred during a SOAP call, but
     * not directly
     * associated with this particular exception.
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fault.webservices.cc.guidewire.com/", "SOAPException"));
