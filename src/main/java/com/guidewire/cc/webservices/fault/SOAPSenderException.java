 ...
 */
public class SOAPSenderException  extends com.guidewire.cc.webservices.fault.SOAPException  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://fault.webservices.cc.guidewire.com/", "SOAPSenderException"));
    }
