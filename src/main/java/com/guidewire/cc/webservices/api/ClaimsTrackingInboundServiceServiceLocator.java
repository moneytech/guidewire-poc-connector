...
public class ClaimsTrackingInboundServiceServiceLocator extends org.apache.axis.client.Service implements com.guidewire.cc.webservices.api.ClaimsTrackingInboundServiceService {
    ...
    public com.guidewire.cc.webservices.api.ClaimsTrackingInboundService getClaimsTrackingInboundService() throws javax.xml.rpc.ServiceException {
    ...
    public com.guidewire.cc.webservices.api.ClaimsTrackingInboundService getClaimsTrackingInboundService(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.guidewire.cc.webservices.api.ClaimsTrackingInboundServiceSoapBindingStub _stub = new com.guidewire.cc.webservices.api.ClaimsTrackingInboundServiceSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.guidewire.cc.webservices.api.ClaimsTrackingInboundService.class.isAssignableFrom(serviceEndpointInterface)) {
                com.guidewire.cc.webservices.api.ClaimsTrackingInboundServiceSoapBindingStub _stub = new com.guidewire.cc.webservices.api.ClaimsTrackingInboundServiceSoapBindingStub(new java.net.URL(ClaimsTrackingInboundService_address), this);
                _stub.setPortName(getClaimsTrackingInboundServiceWSDDServiceName());
                return _stub;
            }
        }
